      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="h-16 flex items-center justify-center border-b border-gray-200">
            <div className="text-xl font-bold text-blue-600">分析系统</div>
          </div>
          ...
          <div className="p-4 border-t border-gray-200">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-sm font-medium text-gray-700">版本 1.0.0</p>
                <p className="text-xs text-gray-500">© 2025 桑坦德银行</p>
              </div>
            </div>
          </div>
        </div>
